...
def walk_forward():
    ...
    while True:
        print "walk forward"
        engine.say("walk forward")
        ret,im=cap.read()
##        print "(*"
        cv2.rectangle(im,(120,340),(520,460),(255,255,255))
##        print "cv2.rectangle(im,(120,340),(520,460),(255,255,255))"
        cv2.imshow("Show",im)
##        print "cv2.imshowm)"
...
##            if ctr==3:
##                print "OBJECT FOUND"
            engine.say("I believe you have reached the coffee maker")
##            cv2.destroyAllWindows()
##                frame = im
##             walk_forward()
##                bring_hand(frame)
